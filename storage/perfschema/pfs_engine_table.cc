...
public:
  ...
  ACL_internal_access_result check(Access want_access,
                                   Access *save_priv) const;

  const ACL_internal_table_access *lookup(const char *name) const;
};

ACL_internal_access_result
PFS_internal_schema_access::check(Access want_access,
                                  Access *save_priv)  const
{
  const Access always_forbidden= /* CREATE_ACL | */ REFERENCES_ACL
...
ACL_internal_access_result
PFS_readonly_acl::check(Access want_access, Access *save_priv) const
{
  const Access always_forbidden= INSERT_ACL | UPDATE_ACL | DELETE_ACL
...
ACL_internal_access_result
PFS_truncatable_acl::check(Access want_access, Access *save_priv) const
{
  const Access always_forbidden= INSERT_ACL | UPDATE_ACL | DELETE_ACL
    | /* CREATE_ACL | */ REFERENCES_ACL | INDEX_ACL | ALTER_ACL
    | CREATE_VIEW_ACL | SHOW_VIEW_ACL | TRIGGER_ACL | LOCK_TABLES_ACL;
...
ACL_internal_access_result
PFS_updatable_acl::check(Access want_access, Access *save_priv) const
{
  const Access always_forbidden= INSERT_ACL | DELETE_ACL
    | /* CREATE_ACL | */ REFERENCES_ACL | INDEX_ACL | ALTER_ACL
...
ACL_internal_access_result
PFS_editable_acl::check(Access want_access, Access *save_priv) const
{
  const Access always_forbidden= /* CREATE_ACL | */ REFERENCES_ACL
...
ACL_internal_access_result
PFS_unknown_acl::check(Access want_access, Access *save_priv) const
{
  const Access always_forbidden= CREATE_ACL
