...
public:
  String column;
  Access rights;
  LEX_COLUMN (const String& x,const  Access & y ): column (x),rights (y) {}
};
...
public:
  ...
  */
  ...
  Access master_access;                /* Global privileges from mysql.user */
  Access db_access;                    /* Privileges for current db */
  ...
  */
  bool check_access(const Access want_access, bool match_any = false);
