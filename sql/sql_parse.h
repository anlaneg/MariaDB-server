...
bool check_one_table_access(THD *thd, Access privilege, TABLE_LIST *tables);
bool check_single_table_access(THD *thd, Access privilege,
			   TABLE_LIST *tables, bool no_errors);
bool check_routine_access(THD *thd, Access want_access,
...
bool check_table_access(THD *thd, Access requirements,TABLE_LIST *tables,
                        bool any_combination_of_privileges_will_do,
                        uint number,
                        bool no_errors);
#else
inline bool check_one_table_access(THD *thd, Access privilege, TABLE_LIST *tables)
{ return false; }
inline bool check_single_table_access(THD *thd, Access privilege,
			   TABLE_LIST *tables, bool no_errors)
{ return false; }
inline bool check_routine_access(THD *thd,Access want_access,
                                 const LEX_CSTRING *db,
                                 const LEX_CSTRING *name,
                                 const Sp_handler *sph, bool no_errors)
{ return false; }
inline bool check_some_access(THD *thd, Access want_access, TABLE_LIST *table)
{
