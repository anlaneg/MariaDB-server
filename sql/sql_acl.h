...
bool mysql_grant(THD *thd, const char *db, List <LEX_USER> &user_list,
                 Access rights, bool revoke, bool is_proxy);
int mysql_table_grant(THD *thd, TABLE_LIST *table, List <LEX_USER> &user_list,
                       List <LEX_COLUMN> &column_list, Access rights,
                       bool revoke);
...
bool check_grant_all_columns(THD *thd, Access want_access,
                             Field_iterator_table_ref *fields);
bool check_grant_routine(THD *thd, Access want_access,
                         TABLE_LIST *procs, const Sp_handler *sph,
                         bool no_error);
bool check_grant_db(THD *thd,const char *db);
bool check_global_access(THD *thd, const Access want_access, bool no_errors= false);
bool check_access(THD *thd, Access want_access, const char *db, Access *save_priv,
...
void get_privilege_desc(char *to, uint max_length, Access access);
...
public:
  ...
  /**
    ...
    @return
      ...
      in save_priv.
  */
  virtual ACL_internal_access_result check(Access want_access,
                                           Access *save_priv) const= 0;
};
...
{
  Access m_grant_option;
#ifndef NO_EMBEDDED_ACCESS_CHECKS
  bool check_access_proxy(THD *thd, List<LEX_USER> &list);
#endif
public:
  Sql_cmd_grant_proxy(enum_sql_command command, Access grant_option)
