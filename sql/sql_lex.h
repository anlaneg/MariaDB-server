...
{
public:
  Lex_column_list_privilege(List<Lex_ident_sys> *columns, Access privilege)
  {
    m_columns= columns;
...
public:
  Lex_grant_privilege() {}
  Lex_grant_privilege(Access grant, bool all_privileges= false)
...
public:
  ...
  */
  ...
  bool stmt_grant_proxy(THD *thd, LEX_USER *user, Access grant_option);
